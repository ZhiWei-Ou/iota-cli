 ...
 * @author Oswin
 * @date 2025-06-25
 * @details Copies from linux/list.h
 *
 * @copyright (c) 2025 Intretech Software Development Department. All Rights Reserved.
 */
/* SPDX-License-Identifier: GPL-2.0 */
#ifndef XTOOL_LIST__H_  // #ifndef _LINUX_LIST_H
#define XTOOL_LIST__H_  // #define _LINUX_LIST_H
/* clang-format off */
...
extern bool __list_add_valid(struct list_head* new_, struct list_head* prev,
 ...
 * @list: The desired new_ front of the list.
 * @head: The head of the list.
 *
 * Rotates list so that @list becomes the new_ front of the list.
 */
